// SOCORRO EU NÃO AGUENTO MAIS CÓDIGO, ACABA LOGO
var camera1, camera2, scene1, scene2, renderer1, renderer2;

// Movimentação do mouse (pog)
...
// Começo parte animação (VAI TOMA NO CU)
init();
animate();
...
function transitionToNextPage() {
    // transição mais fodase possível
    document.body.classList.add('fade-out');

    // leva pro outro bagulho
    setTimeout(function() {
        window.location.href = './sistema2d/sistema2d.html'; // redirecionamento
