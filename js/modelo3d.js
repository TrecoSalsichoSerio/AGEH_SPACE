/*Funções básicas (canvas, tamanho, rotação, etc)*/
(function(){
  var TAU, isSpinning, illo, planets, k, planet, ref$, i$, to$, i, orbit, n, animate;
  TAU = Zdog.TAU;
  isSpinning = true;
  ...
  planets = {
    ...
    mercury: {
      ...
      orbitTilt: -TAU * 0.019,
      orbitNode: -TAU * 0.314,
      satelliteOf: 'sun' /*Define ao redor do que o bagulho vai rodar*/
    },
    venus: {
      diameter: 1.5,
      color: '#c18f17',
  ...
  /*Define a órbita dos planeta*/
  for (k in planets) {
    planet = planets[k];
    planet.ring == null && (planet.ring = 0);
    planet.anchor = new Zdog.Anchor({
      addTo: ((ref$ = planets[planet.satelliteOf]) != null ? ref$.planet : void 8) || illo,
      translate: {
